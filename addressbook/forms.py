...
PhoneEditFormSet = inlineformset_factory(Contact, PhoneNumber, extra=1)
AddressEditFormSet = inlineformset_factory(Contact, Address, extra=1, formset=MandatoryInlineFormSet)
WebsiteEditFormSet = inlineformset_factory(Contact, Website, extra=1)
SocialNetworkEditFormSet = inlineformset_factory(Contact, SocialNetwork, extra=1)
