...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhoneNumber.phone'
        db.alter_column('addressbook_phonenumber', 'phone', self.gf('django.db.models.fields.CharField')(max_length='20'))

    def backwards(self, orm):

        # Changing field 'PhoneNumber.phone'
        db.alter_column('addressbook_phonenumber', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20))
